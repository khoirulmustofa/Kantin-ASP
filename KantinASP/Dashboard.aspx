<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MasterPages/Main.Master"
    AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="KantinASP.Dashboard" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Dasboard | PT Khoirul Mustofa</title>
</asp:Content>
                            ...
                            <div class="form-horizontal">
                                <div class="control-group">
                                    <h1>
                                        ...
                                        <span>
                                            <asp:Button ID="btnSearchNik" runat="server" class="btn btn-sm btn-warning" Text="Search" /></span>
                                    </h1>
                                </div>
                                <hr />
                                <div class="span3">
